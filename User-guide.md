...
#### 4 -> Qualité de l’air à une position
  - Si vous avez choisi l'option 4, renseignez les informations suivantes :
    ...
    - Longitude
    - Date/heure
  - Après avoir suivi les instructions, l'application vous donnera une estimamtion la qualité de l’air à cet endroit
...
- Il vous suffira alors de choisir entre les options suivante :
    - "Cet utilisateur est fiable".
    - "Cet utilisateur n'est pas fiable, le retirer de l'application".
...
- Une fois que l'ID de l'utilisateur sera renseigné, l'application vous indiquera le status de l'utilisateur parmit :
    - "Cet utilisateur est fiable".
    - "Cet utilisateur n'est pas fiable, il est retiré de l'application".
